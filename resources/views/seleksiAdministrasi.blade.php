                        ...
                        @foreach ($data as $index => $row)
                            <tr>
                                ...
                                <td class="action-buttons">
                                    <form action="{{ route('lulusSeleksiAdministrasi', ['idloker' => $row->idloker, 'idapply' => $row->id_apply]) }}" method="POST">
                                        @csrf
                                    ...
                                    <form action="{{ route('tidakLulusSeleksiAdministrasi', ['idloker' => $row->idloker, 'idapply' => $row->id_apply]) }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="id_apply" value="{{ $row->id_apply }}">
